...
module.exports = {
    createIteration: async function (req, res) {
        ...
        var insertQuery = `INSERT INTO ceat_project_data(createdAt, updatedAt,dataCellNumber, fkParameterId, fkSubIterationId, fkIterationId, fkProjectId) VALUES `
        ...
        if (iterationResult && iterationResult.length > 0) {
            ...
            if (createdIteration) {
                console.log('createdProject--', createdIteration);
                ...
                if (createdSubIteration) {
                    for (let i = 0; i < parameters.length; i++) {
                        ...
                        insertQuery += `(${currentDate},${currentDate},'${parameter.cellNumber}',${parameter.parameterId},${createdSubIteration.id},${createdIteration.id},${iteration.fkProjectId}),`
                    }
